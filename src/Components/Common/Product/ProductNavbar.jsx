...
const ProductNavbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-blue-700 text-base font-semibold text-white ">
        ...
        <div className="hidden md:flex items-center gap-6">
          {isLoggedIn ? (
            <div className="relative group">
              <button className="flex items-center gap-1 hover:text-emerald-500">
                ...
                <span className="ml-1">
                  <X className="hidden" />{" "}
                  {/* Placeholder for ChevronDown if needed */}
                </span>
              </button>
              {/* Dropdown */}
              <div className="absolute top-full left-1/2 -translate-x-1/2 w-48 bg-white shadow-lg py-2  opacity-0 group-hover:opacity-100 invisible group-hover:visible transition-opacity duration-200 z-50">
                <ul className="flex flex-col justify-start px-4 py-2 space-y-5 text-sm font-medium text-gray-700 ">
                  <li
                    className="hover:bg-slate-100 flex items-center gap-1 cursor-pointer"
                    onClick={() => {
                      navigate("/account");
                    }}
                  >
                  ...
                  <li className="hover:bg-slate-100 flex items-center gap-1 cursor-pointer">
          ...
          <div className="flex flex-col justify-center items-center  relative group min-w-[100px] z-50">
            <div className="relative">
              ...
              {/* Dropdown */}
              <div className="absolute top-full -left-15 -translate-x-1/2 w-50 bg-white shadow-xl/30  py-2 opacity-0 group-hover:opacity-100 invisible group-hover:visible transition-all duration-200 z-50">
      ...
      {/* Sidebar Panel */}
      <div
        className={`fixed top-0 left-0 h-screen w-64 bg-white text-black font-normal shadow-lg z-50 transform transition-transform duration-300 ${
